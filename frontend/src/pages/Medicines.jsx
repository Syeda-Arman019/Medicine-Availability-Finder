...
// Path setup: '../MedicinesData' agar Medicines.jsx 'pages' folder me hai
import { MEDICINES as ALL_MEDICINES } from "./MedicinesData";
...
export default function Medicines({ cart = [], addToCart, removeFromCart }) {
  ...
  const categories = ["All", ...new Set(ALL_MEDICINES.map((med) => med.category))];
    ...
    <div className="mf-page medicines-page">
                    ...
                    <ul className="mf-cart-list">
                      {cart.map((item, i) => (
                        <li key={item.id || i}>
                          ...
                          <button
                            onClick={() => removeFromCart(item.id !== undefined ? item.id : i)}
        ...
        <div className="container mf-navbar-inner">
          ...
          <div className="collapse navbar-collapse" id="mfNav">
            <ul className="navbar-nav mf-nav-links">
              ...
              <li className="nav-item"><Link className="nav-link active" to="/medicines">Medicines</Link></li>
      ...
      <header className="med-header-banner">
        <div className="container">
          ...
          <p>Find genuine medicines, check live availability, and add them to your cart.</p>
        </div>
      </header>
        ...
        <div className="med-filter-bar">
          ...
          <div className="med-category-chips">
            {categories.map((category) => (
              <button
                key={category}
                className={`med-chip ${selectedCategory === category ? "active" : ""}`}
              ...
              {filteredMedicines.map((m) => (
                <div className="med-card" key={m.id}>
                  ...
                  <div className="med-card-body">
                    ...
                    <h4 className="med-title">{m.name}</h4>
                    <p className="med-pack">{m.pack}</p>
